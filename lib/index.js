...
reset.addEventListener('click', resetPage);
  ...
  function addAdvice() {
    ...
    $.ajax('https://pacific-hamlet-18372.herokuapp.com/api/v1/slips/', {
      ...
      success: function(result) {alert(`${new_advice} has been added to advice database!`);
                }
    })
    alert("Your advice has been added!");
    var element = document.getElementById("submit-advice");
    element = ""
}
